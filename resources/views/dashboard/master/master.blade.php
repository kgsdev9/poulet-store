...
<head>
    <meta charset="utf-8" />
    <title>Administration ECOMMERCE</title>
    ...
    <link rel="stylesheet" href="{{asset('ressources/libs/jsvectormap/css/jsvectormap.min.css')}}">


    <!--Swiper slider css-->

    <link rel="stylesheet" href="{{asset('ressources/libs/swiper/swiper-bundle.min.css')}}">

    <!-- Layout config Js -->

    <link rel="stylesheet" href="{{asset('ressources/js/layout.js')}}">
    <!-- Bootstrap Css -->

    <link rel="stylesheet" href="{{asset('ressources/css/bootstrap.min.css')}}">
    <!-- Icons Css -->

    <link rel="stylesheet" href="{{asset('ressources/css/icons.min.css')}}">
    <!-- App Css-->

    <link rel="stylesheet" href="{{asset('ressources/css/app.min.css')}}">
    <!-- custom Css-->

    <link rel="stylesheet" href="{{asset('ressources/css/custom.min.css')}}">
@livewireStyles()
</head>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            src="{{asset('ressources/images/users/avatar-1.jpg')}}" alt="Header Avatar">
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="text-sm-end d-none d-sm-block">
                                Termes et conditions de notre application
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{asset('ressources/libs/node-waves/waves.min.js')}}"></script>
     <script src="{{asset('ressources/libs/feather-icons/feather.min.js')}}"> </script>
    <script src="{{asset('ressources/js/pages/plugins/lord-icon-2.1.0.js')}}"></script>
    <script src="{{asset('ressources/js/plugins.js')}}"></script>
    <script src="{{asset('ressources/libs/apexcharts/apexcharts.min.js')}}"></script>
    <script src="{{asset('ressources/libs/jsvectormap/js/jsvectormap.min.js')}}"></script>
    <script src="{{asset('ressources/libs/jsvectormap/maps/world-merc.js')}}"></script>
    <script src="{{asset('ressources/libs/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{asset('ressources/js/pages/dashboard-ecommerce.init.js')}}"></script>
